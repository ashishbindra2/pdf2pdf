...
if __name__ == "__main__":
    input_image_path = "data/images/Holidays.pdf/page_1.png"  # Replace with your image file path
    target_language = "hi"  # Replace with the target language code (e.g., 'es' for Spanish)
    output_pdf_path = "data/translated_.pdf"  # Replace with desired output PDF file path
    ...
    text = pytesseract.image_to_string(Image.open(input_image_path), lang='eng', config='--psm 11')
